...
export default function CompressPdfPage() {
  ...
  const compressPdf = async () => {
    ...
    try {
      ...
      // Load worker reliably from local public folder
      ...
      <div className="max-w-3xl mx-auto">
        <div className="mb-8">
          ...
          <p
            ...
            data-aos-delay="100"
          >
            Best for scanned PDFs. Text pages may be rasterized to improve
            compression.
          </p>
        </div>
            ...
            >
              ...
              <div className="flex items-center justify-center gap-4 text-muted-foreground mb-8">
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-foreground font-semibold line-through decoration-red-500/50">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span
                    className={`${compressedSize < (file?.size || 0) ? "text-accent" : "text-red-500"} font-bold text-xl`}
                  >
              ...
              {compressedSize < (file?.size || 0) ? (
                ...
                <p className="text-red-500 font-medium mb-8">
                  File size increased. This PDF was already optimized or
                  text-based.
                  <br />
                  <span className="text-sm text-muted-foreground">
                    Try selecting "High" compression.
                  </span>
                </p>
              )}
                ...
                <div className="bg-muted/30 border border-border/50 rounded-2xl p-6">
                  ...
                  <div className="flex items-center justify-between mb-8 p-4 bg-background rounded-xl border border-border">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="font-semibold text-lg line-clamp-1 break-all">
                          {file.name}
                        </p>
