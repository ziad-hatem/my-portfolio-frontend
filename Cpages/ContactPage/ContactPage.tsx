            ...
            <div className="space-y-6 mb-12">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-sm">ziad@ziadhatem.live</div>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-sm">ziadhatem.live</div>
                </div>
              </a>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-input-background border border-border rounded-lg focus:outline-none focus:border-accent text-[#19192E] transition-colors"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-3 bg-input-background border border-border rounded-lg focus:outline-none focus:border-accent text-[#19192E] transition-colors resize-none"
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-8 py-3 bg-accent text-accent-foreground rounded-lg hover:bg-accent/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
                  <>
